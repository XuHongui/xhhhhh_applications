...
function Dasheninfo(props){
    ...
    return (
        <div style={{position: "relative"}}>
            ...
            <NavBar back = {null} style = {{background: "RGB(20,211,122)", color: "white"}}>大神信息完善</NavBar>
            <List>
...
export default connect((state) => ({user: state.user}), {updata})(Dasheninfo);